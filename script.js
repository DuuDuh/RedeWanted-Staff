  ...
  form.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      errorBox.textContent = networkFailure
        ? "O servidor de candidaturas está indisponível. Tente novamente mais tarde."
        : error.message || "Não foi possível enviar agora. Confira os campos e tente novamente.";
